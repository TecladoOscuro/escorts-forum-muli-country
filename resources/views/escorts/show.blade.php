        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1">
                ...
                <div class="glass-card p-4 mt-4 space-y-3">
                    ...
                    @if($currentTenant->feature('show_contact_buttons'))
                        @if($escortProfile->contact_phone)
                            @php $cleanPhone = preg_replace('/[^0-9+]/', '', $escortProfile->contact_phone); @endphp
                            <a href="https://wa.me/{{ ltrim($cleanPhone, '+') }}" target="_blank" rel="noopener noreferrer"
                                class="flex items-center justify-center gap-2 w-full py-2 text-sm font-medium rounded-lg text-white bg-[#25D366] hover:bg-[#20bd5a] transition-colors btn-press">
                        ...
                        @endif
                        @if($escortProfile->contact_telegram)
                            @php $tgUser = ltrim($escortProfile->contact_telegram, '@'); @endphp
                            <a href="https://t.me/{{ $tgUser }}" target="_blank" rel="noopener noreferrer"
                                class="flex items-center justify-center gap-2 w-full py-2 text-sm font-medium rounded-lg text-white bg-[#0088cc] hover:bg-[#0077b5] transition-colors btn-press">
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div x-data="{ tab: 'about' }">
                    ...
                    <div x-show="tab === 'about'" class="space-y-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach($escortProfile->services as $service)
                                        @if($currentTenant->feature('show_service_tags'))
                                            <a href="{{ route('escorts.index', ['service' => $service]) }}" class="px-3 py-1 text-sm rounded-full bg-[var(--color-surface-hover)] text-[var(--color-text-secondary)] border border-[var(--color-border)] hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] transition-colors">{{ $service }}</a>
                                        @else
                        ...
                        @if($escortProfile->rates && $currentTenant->feature('show_prices'))
                            <div class="glass-card p-5">
